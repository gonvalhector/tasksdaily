function userHelp(element) {
    ...
    */
    ...
    if (className.includes(subStr) === true) {
        ...
        tip.hide() = (tip.hide() === true) ? false : true;
    }
}
...
$(function() {
    ...
    usernameInput.on("focus", userHelp(usernameInput));
    ...
    firstNameInput.on("focus", userHelp(firstNameInput));
    ...
    lastNameInput.on("focus", userHelp(lastNameInput));
    ...
    emailInput.on("focus", userHelp(emailInput));
